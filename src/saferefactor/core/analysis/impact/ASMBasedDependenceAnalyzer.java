...
public class ASMBasedDependenceAnalyzer implements TransformationAnalyzer {
	...
	public ASMBasedDependenceAnalyzer(Project source, Project target,
			String tmpDir, String clazz) {
		this.source = source;
		this.target = target;
		this.clazz = clazz;
	}
	...
	private void addCallees(String clazz) {
