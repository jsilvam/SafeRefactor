...
public class ClassNode extends AbstractEntity implements Entity {
	...
	private Set<MethodNode> overloadedMethods;
	...
	private boolean isPrimitive(String name) {
		...
		if (name.equals("void") || name.equals("boolean") || name.equals("byte") || name.equals("char")
			...
			|| name.equals("double") || name.equals("void") ) return true;
	...
	public Set<MethodNode> getOverloadedMethods() {
		return overloadedMethods;
	}

	public void setOverloadedMethods(Set<MethodNode> overloadedMethods) {
