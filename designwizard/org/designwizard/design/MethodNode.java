...
public class MethodNode extends AbstractEntity implements Entity {
	...
	private MethodNode overridenMethod;
	private MethodNode overridenBy;
	private boolean isConstructor;
	public final static String CONSTRUCTOR_IDENTIFIER = "<init>";
	private List<ClassNode> parameters;
...
//		String signature = this.name.substring(this.name.indexOf("("));
		...
		if (indexOf != -1)
			shortName = this.name.substring(0,indexOf);
...
//		return shortName + signature;
	...
	public void setParameters(List<ClassNode> methodParameters) {
     ...
     * represents
     */
	public List<ClassNode> getParameters() {
	...
	public MethodNode getOverridenMethod() {
		return overridenMethod;
	}

	public void setOverridenMethod(MethodNode overridenMethod) {
		this.overridenMethod = overridenMethod;
	}

	public MethodNode getOverridenBy() {
		return overridenBy;
	}

	public void setOverridenBy(MethodNode overridenBy) {
